    ...
    <View style={styles.container}>    
      ...
      <View style={{alignContent:'center',margin:'auto',marginLeft:'45%'}}>
        <View style={{color:'rgb(180, 100, 10)',marginTop:'-30%',fontSize:20}} >
          ...
          <Text style={{color:'rgb(180, 100, 10)',fontSize:16,marginLeft:'-30%'}}>Have a blissful day and enjoy</Text>
        </View>

        <marquee style={{color:'rgb(252, 70, 0)',fontSize:32}} behavior="slide" direction="Right">Happy Birthday to you...</marquee>

        <View style={{color:'rgb(206, 188, 84)',marginLeft:'20%',marginTop:10,fontSize:22}}>

          <marquee style={{color:'Blue',}} behavior="slide" direction="up">Wishing you  </marquee>
          <marquee style={{color:'Blue',marginLeft:'-10%'}} behavior="slide" direction="up">success,Joy and</marquee>
          <marquee style={{color:'Blue',marginLeft:'-20%'}} behavior="slide" direction="up">Happiness always.... </marquee>
        </View>
      </View>
       </ImageBackground> 
    </View>
